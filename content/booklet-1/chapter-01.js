...
BOOKLET_CONTENT["1-1"] = {
  content: [
    ...
    { type: "quote", text: "And the angel of YHWH called to Abraham out of the heavens the second time, and said: By myself I swear\u2014declaration of YHWH! For because you have done this word, and have not withheld your son, your only, yes, to bless, I will bless you. And to multiply, I will multiply your seed as the stars of the heavens, and as the sand which is upon the sea shore; and your seed will take possession of the gate of his enemies.", source: "Bereshit 22:15-17" },
    ...
    { type: "quote", text: "Let everything that has breath praise Yah! Hallelu-Yah!", source: "Tehilim 150:6" },
    ...
    { type: "quote", text: "Hear, O Israel: YHWH our Elohim is one YHWH: And you will love Aleph Tav YHWH, your Elohim with all thine heart, and with all your soul, and with all your might.", source: "Devarim 6:4-5" },
    ...
    { type: "quote", text: "Searching to find out for what time, or what circumstance indicated the Spirit of Mashiah which was in them, and which testified beforehand the sufferings of Mashiah, and the glories which would be followed.", source: "1 Petros 1:11" },

    { type: "heading", text: "Yehoshua Mashiah, the Light" },

    { type: "quote", text: "In the beginning Elohim created the heavens and the Earth. And the Earth became tohu, and bohu; and the darkness was upon the faces of the abyss, and the Spirit of Elohim hovered upon the faces of the waters. And Elohim said: The light will appear! And the light appeared. And Elohim saw the light, that it was good, and Elohim separated the light from the darkness. And Elohim called the light day, and the darkness he called night. And the evening appeared, and the morning appeared: Day one.", source: "Bereshit 1:1-5" },

    "What light is it really question of in this passage? Is it the Sun? Assuredly not, because the Scriptures tell us that \u201Cthe greater light to rule the day\u201D was created only on the fourth day (Bereshit 1:14-19). Moreover, there is no question here of a creative act. Indeed, Elohim says, \u201CThe light will appear\u201D. The verb to appear needs to be understood in the sense of to \u201Cbring up\u201D or \u201Cmake visible\u201D. Take notice that the earth became without form and void because darkness reigned. The light that appears seemed to be none other than Yehoshua Mashiah Himself who intervenes to destroy the works of the Devil. Thus, from the very beginning of Bereshit, the incarnation of the Mashiah had been announced.",

    { type: "quote", text: "Nevertheless the dimness will not be such as was in her vexation, when at the first he lightly afflicted the land of Zebulun and the land of Naphtali, and afterward did more grievously afflict her by the way of the sea, beyond Yarden, in Galilee of the nations.", source: "Yesha'yah 8:23" },

    { type: "quote", text: "But Yehoshua having heard that Yohanan had been put in prison, withdrew into Galilee. And having left Nazareth, he came and dwelt in Capernaum, a city by the sea, in the territories of Zebouloun and Naphtali, that might be fulfilled which was spoken through Yesha\u2018yah the prophet, saying: The country of Zebouloun and the country of Naphtali, the way of the sea, beyond the Yarden, and Galilee of the nations, the people sitting in darkness has seen a great light, and to those who were sitting in the region and in shadow of death, light has risen.", source: "Mattithyah 4:12-16" },

    { type: "heading", text: "Yehoshua Mashiah the Posterity (Seed)" },

    "Elohim told Eve about the birth of a posterity that would crush the serpent\u2019s head (Bereshit 3:15). This promise was renewed particularly to the father of faith, Abraham.",

    { type: "quote", text: "And he brought him forth abroad, and said: Look now toward heavens, and count the stars, if you are able to count them! And he said to him: So will become your seed.", source: "Bereshit 15:5" },
    ...
    { type: "quote", text: "Thus says YHWH the King of Israel, and his redeemer YHWH Tsevaot; I am the first, and I am the last; and beside me there is no Elohim.", source: "Yesha'yah 44:6" },
    ...
    "The Lordship of Yehoshua is clearly established in the Scriptures. He must be the only one to reign in our lives (Tehilim 47:3; Yesha'yah 44:6; Mattithyah 2:1-6; Loukas 23:3; Yohanan 19:21-22; Loukas 19:35-38; Revelation 19:11-16).",
    ...
    { type: "list", items: [
      "The Magi (Mattithyah 2:11)",
      "The disciples (Mattithyah 14:33; Loukas 24:52)",
      "The Canaanite woman (Mattithyah 15:25)",
      "The man born blind that was later healed (Yohanan 9:38)",
      "The two women named Mary (Mattithyah 28:9)",
    ...
    "Furthermore, if Yehoshua is not Elohim, YHWH would have never let people worship Him, but would have rather punished Him for it. Yehoshua Mashiah Himself declared forcefully to Satan that we should only worship Elohim (Loukas 4:8).",

    { type: "quote", text: "I am YHWH: that is my name: and my glory will I not give to another, neither my praise to graven images.", source: "Yesha'yah 42:8" },
    ...
    { type: "quote", text: "And we, we have seen and do testify that the Father sent the Son, the Savior of the world.", source: "1 Yohanan 4:14" },
    ...
    { type: "list", items: [
      "He came from Heaven: \u201CBut no one has ascended up to heaven, except he that came down from heaven, the Son of human who is in heaven.\u201D (Yohanan 3:13). In this passage, Yehoshua clearly says that He is both on earth and in heaven at once.",
      "He is omnipresent: \u201CFor where two or three are gathered together in my name, there am I in the midst of them.\u201D (Mattithyah 18:20).",
      "He is the Father: \u201CPhilippos says to him: Lord, show us the Father, and it is enough for us. Yehoshua says to him: I am for so long time with you, and you have not known me, Philippos! He who has seen me has seen the Father. And how can you say: Show us the Father?\u201D (Yohanan 14:8-9)."
    ] },
    ...
    "Take notice also that Yohanan adds in Revelation 22:6 that Elohim sent His angel to show His servants the things that must happen soon. In verse 16, Yehoshua said he is the one who sent His angel.",
  ...
  footnotes: {
    ...
    "Eliyah": "Elijah, from Eli (my El) and Yah (YHWH): 'my El is YHWH'",
    ...
    "El Elyon": "Elohim Most High, from El (God) and Elyon (highest, supreme)",
    "El Gadowl": "the Great Elohim, from El (God) and Gadowl (great)",
    ...
    "presages": "omens; predictions of the future",
    "sacerdotal": "relating to priests or the priesthood",
    "ablutions": "ceremonial washings",
    "brass laver": "bronze washing basin used by priests for ritual purification",
    "shewbread": "sacred bread displayed in the tabernacle, also called 'bread of the Presence'",
    "declinations": "grammatical word forms (inflections)",
    "verily": "truly, indeed",
    "hidest": "hides (archaic English verb form)",
    "thine": "your (archaic English)",
    "wrought": "worked, accomplished",
    "whelp": "a young animal — here, a lion cub",
    "couched": "crouched or lay down, like an animal ready to spring",
    "foal": "a young donkey or horse",
    "colt": "a young male donkey or horse",
    "taketh": "takes (archaic English verb form)",
    "plenteous": "abundant, plentiful",
    "dispensation": "a period or arrangement in Elohim's plan for dealing with humanity",
    "incarnation": "Elohim taking on a human body and flesh",
    "theophany": "a visible appearance of Elohim to human beings",
    "theophanies": "visible appearances of Elohim to human beings",
    "typology": "the study of symbols and foreshadowings in the Bible",
    "allegory": "a story where characters or events represent deeper spiritual truths",
    "allegories": "stories where characters or events represent deeper spiritual truths",
    "Levitical priesthood": "the priestly system from the tribe of Levi, established under Moses",
    "tabernacle": "the portable tent-sanctuary Israel carried in the wilderness",
    "sanctuary": "a holy place of worship",
    "Holy of Holies": "the innermost sacred room of the tabernacle where Elohim's presence dwelt",
    "Mosaic ordinances": "religious laws and regulations given through Moses",
    "tithe": "a tenth of one's goods given as an offering to Elohim",
    "epistle": "a letter — specifically, one of the New Testament letters",
    "epistles": "letters — specifically, the New Testament letters",
    "patriarchs": "the founding fathers of Israel: Abraham, Isaac, and Jacob",
    "Tetragrammaton": "the four Hebrew letters YHWH — Elohim's revealed personal name",
    "Godhead": "the divine nature or being of Elohim",
    "deity": "divine nature, godhood",
    "divinity": "the state of being Elohim; divine nature",
    "piety": "devotion and reverence toward Elohim",
    "impiety": "lack of devotion to Elohim; ungodliness",
    "piously": "with devotion and reverence toward Elohim",
    "idolatry": "the worship of false elohim or images",
    "redeemer": "one who pays a price to set someone free from bondage",
    "redemption": "the act of being set free; deliverance through a price paid",
    "omnipresent": "present everywhere at the same time",
    "pre-existence": "existing before being born on earth",
    "graven image": "a carved idol or statue worshipped as an elohim",
    "Passover": "the Jewish festival commemorating Israel's deliverance from slavery in Egypt",
    "manna": "miraculous bread Elohim provided from heaven during Israel's time in the wilderness",
    "celestial": "relating to the sky or heavens",
    "firmament": "the sky; the expanse of the heavens",
    "enigmatic": "mysterious, hard to understand",
    "scrutinized": "examined very closely",
    "eunuch": "a court official; historically, a castrated man serving in a royal court",
    "archetype": "the original pattern or model that others follow",
    "terrestrial": "earthly, of this world",
    "servitude": "the state of being a slave; bondage",
    "predestined": "determined or decided in advance by Elohim",
    "apparitions": "visible appearances or manifestations — here, of Elohim appearing to people",
    "apparition": "a visible appearance or manifestation — here, of Elohim appearing to people",
    ...
    "Yah": "short form of YHWH, Elohim's personal name",
    "torah": "the Law; the first five books of the Bible given through Moses",
    "Kyrios": "Greek word for 'Lord'",
    "Adoni": "'my lord' — singular form of Adonai, used for humans not for Elohim",
    "Hashem": "'The Name' — how Jews refer to Elohim in everyday speech",
