/**
 * Booklet 1, Chapter 4: One Faith
 * Author: Jules
 * Based on: La Foi by Shora Kuetu
 *
...
BOOKLET_CONTENT["1-4"] = {
  content: [
    ...
    "The seven sons of Sceva in Acts 19 are a clear example. They knew the name of Yehoshoua, they believed it was powerful, and they tried to use it \u2014 but they had no faith. The result was disaster. Knowledge of the truth is not the same as living trust in the One who is Truth.",

    { type: "heading", text: "What Faith Actually Is" },
    ...
    { type: "heading", text: "Your Ears Are the Gates of Faith" },

    "Because faith comes through hearing, your ears are the gates through which faith either enters or is blocked. The Lord says to every church in Revelation: \u201CHe who has an ear, let him hear what the Spirit says.\u201D This is repeated seven times, once for each church, showing how seriously Eloh\u00EEm takes the condition of our spiritual hearing.",

    "But not everyone who hears the Word receives faith. Using the parable of the sower, it is necessary to note that only one in four people who hear the Word actually produce fruit. The difference lies in what they do with what they hear.",

    "The Hebrew word <i>shama</i>, translated hear, carries three meanings at once: to hear, to understand, and to obey. The person in whom the Word produces faith is the one who:",

    { type: "list", items: [
      "Hears the Word",
      "Understands it with their heart, not just their intellect",
      "Obeys it in practice",
      "Guards it, refusing to let it be taken away by the enemy, by persecution, or by the distractions of wealth"
    ] },

    "Those who have faith are not more intelligent, richer, or less sinful than others. But they have made their hearts good soil for the seed of the Lord. They have one will: they hear about salvation and they want to be saved, whatever the cost.",
    ...
    { type: "heading", text: "What Faith Produces" },
    ...
    { type: "statement", text: "It is only faith in Yehoshoua alone that saves." },
    ...
    { type: "statement", text: "Faith is the work of Eloh\u00EEm. Our part is to receive it." },

    { type: "heading", text: "Faith Produces Works" },
    ...
    { type: "heading", text: "Faith Is Tested and Refined" },
    ...
    { type: "heading", text: "What Threatens Your Faith" },

    "From the moment a person believes, their faith becomes a target. Below are five main threats.",
    ...
    "These three emotions are direct enemies of faith:",
    ...
    "The love of money is the root of all evils \u2014 for those who have desired it, some have wandered from the faith (1 Timothy 6:10). This is why we are sharp in our critique of what is called the prosperity gospel. This is a carnal, materialistic faith that directs the believer\u2019s hope toward passing things rather than eternal life.",
    ...
    { type: "statement", text: "Faith is not a one-time event. It is a life walked." },
    ...
    "As a new believer, here is what you need to hold on to:",

    { type: "list", items: [
      "Faith is not just intellectual, it is a complete surrender of your heart and life to Yehoshoua.",
      "Faith comes only from the Word of Eloh\u00EEm. Protect that source.",
      "The goal of faith is salvation and eternal life, not worldly blessings.",
      "Faith that is real will produce fruit: a changed life and love for others.",
      "Trials and tests do not destroy faith, they refine it like gold in fire.",
